...
<div class="space-y-6">
    ...
    <div class="bg-white/80 backdrop-blur-sm border border-emerald-100 rounded-xl shadow-sm dt-card">
        <div class="p-4">
            <table id="tablaTipos" class="stripe hover w-full text-sm"></table>
        </div>
    </div>
...
<div id="modalTipo" class="hidden fixed inset-0 z-50">

    <div class="absolute inset-0 bg-black/40" data-modal-close="modalTipo"></div>

    <div class="relative mx-auto mt-16 w-11/12 sm:w-[34rem] bg-white rounded-xl shadow-2xl overflow-hidden">

        <div class="px-5 py-4 border-b flex items-center justify-between">
            <h3 class="text-lg font-semibold" id="modalTipoTitulo">Agregar categoría</h3>
            <button type="button" class="p-2 rounded hover:bg-gray-100" data-modal-close="modalTipo" aria-label="Cerrar">
        ...
        <form id="formTipo">
            @csrf
            <input type="hidden" id="tprod_id" name="tprod_id" value="">

            <div class="px-5 py-4 space-y-4">
                <div>
                    <label for="tprod_nombre" class="block text-sm font-medium text-gray-700">Nombre</label>
                    <input type="text" id="tprod_nombre" name="tprod_nombre" maxlength="100"
                        class="mt-1 w-full rounded-lg border-gray-300 focus:border-emerald-400 focus:ring-emerald-400 text-sm"
                        placeholder="Ej. Hogar, Limpieza, Cocina, Golosinas...">
                </div>

                <div>
                    <label for="tprod_desc" class="block text-sm font-medium text-gray-700">Descripción</label>
                    <textarea id="tprod_desc" name="tprod_desc" rows="3"
                        class="mt-1 w-full rounded-lg border-gray-300 focus:border-emerald-400 focus:ring-emerald-400 text-sm"
...
@endsection
@vite('resources/js/productos/categorias.js')