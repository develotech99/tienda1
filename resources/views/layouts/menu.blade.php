        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden lg:flex items-center gap-1">
                    ...
                    <!-- Reparaciones -->
                    <div class="relative group" data-menu="respo">
                        <button type="button"
                                class="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 transition"
                                aria-haspopup="true" aria-expanded="false" aria-controls="menu-respo">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div id="menu-respo"
                             class="invisible opacity-0 translate-y-1 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 transition-all absolute left-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-40"
                             role="menu" aria-label="Submenú Reparaciones">

                            <a href="{{ url('/reparaciones') }}"
                               class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-emerald-50 transition group" role="menuitem">
                                <div class="p-1.5 bg-orange-100 rounded-lg group-hover:bg-orange-200 transition">
                                    <svg class="w-4 h-4 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                </div>
                                <span class="flex-1">En Proceso</span>
                            </a>
                            ...
                            <a href="{{ url('/reparaciones/create') }}"
                               class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-emerald-50 transition group" role="menuitem">
                                ...
                                <span class="flex-1">Crear Orden de Reparación</span>
                            </a>

                            <a href="{{ url('/reparaciones/historial') }}"
                               class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-emerald-50 transition group" role="menuitem">
                                <div class="p-1.5 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition">
                                    <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            ...
                            <a href="{{ url('/servicios') }}"
                               class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-emerald-50 transition group" role="menuitem">
                                ...
                                <span class="flex-1">Servicios Programados</span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="px-4 py-3 space-y-1">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div class="hidden flex-col" data-accordion-panel="productos">
                        ...
                        <a href="{{ url('/reportes/productos') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Reporte</a>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button type="button" class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-700 hover:bg-emerald-50"
                            data-accordion-btn="respo">
                        <span>Reparaciones</span>
                        <svg class="w-4 h-4 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    <div class="hidden flex-col" data-accordion-panel="respo">
                        <a href="{{ url('/reparaciones') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">En Proceso</a>
                        <a href="{{ url('/reparaciones/create') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Crear Orden de Reparación</a>
                        <a href="{{ url('/reparaciones/historial') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Historial</a>
                        <a href="{{ url('/servicios') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Servicios Programados</a>
                    </div>
                </div>
    ...
    <script>
        ...
        $$( '[data-accordion-btn]' ).forEach(btn => {
            ...
            btn.addEventListener('click', () => {
                ...
                // Cerrar otros
                $$( '[data-accordion-panel]' ).forEach(p => { if (p !== panel) p.classList.add('hidden'); });
                $$( '[data-accordion-btn]' ).forEach(b => { if (b !== btn) b.querySelector('svg')?.classList.remove('rotate-180'); });
                // Toggle actual
